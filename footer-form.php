    ...
    <footer class="footer">
        <div class="container-fluid no-padding">
            <div class="footer__contact container-width">

                <?php $template_file = get_post_meta( get_queried_object_id(), '_wp_page_template', true );

                if ($template_file == 'templates/template-contactus-page.php') {
                    echo '<h3 class="footer__title">' . $contact_footer_title . '</h3>';
                } else {
                    echo '<h3 class="footer__title">' . $footer_title . '</h3>';
                } ?>

                <div class="footer__form">
                    <?php echo do_shortcode($contact_form_7shortcode); ?>
                </div>
            </div>
